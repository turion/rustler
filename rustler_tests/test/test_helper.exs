...
defmodule RustlerTest.Helpers do
  @moduledoc false
  use ExUnit.Case
  ...
  def run_ser(test_name, expected_term) do
    serialized = RustlerTest.serde_test("serialize", test_name, expected_term)
  ...
  def run_de(test_name, expected_term) do
    deserialized = RustlerTest.serde_test("deserialize", test_name, expected_term)
  ...
  def run_transcode(test_name, in_term, out_term) do
    transcoded = RustlerTest.transcode(in_term)
