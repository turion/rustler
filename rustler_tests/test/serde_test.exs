defmodule RustlerTest.SerdeTest.NewtypeStruct do
  require Record
  @type t :: {__MODULE__, non_neg_integer}
  Record.defrecord(:record, __MODULE__, num: 0)
end

defmodule RustlerTest.SerdeTest.NewtypeVariant do
  defmodule N do
    require Record
    @type t :: {__MODULE__, non_neg_integer}
    Record.defrecord(:record, __MODULE__, num: 0)
...
defmodule RustlerTest.SerdeTest.Struct do
  defstruct r: 0, g: 0, b: 0
end

defmodule RustlerTest.SerdeTest.StructVariant do
  defmodule S do
    defstruct r: 0, g: 0, b: 0
  end
end

defmodule RustlerTest.SerdeTest do
  use ExUnit.Case

  alias RustlerTest.Helpers

  alias RustlerTest.SerdeTest.{
    NewtypeStruct,
    NewtypeVariant,
    TupleStruct,
    TupleVariant,
